...
namespace HomeService.Infrastructure.EfCore.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "Id", "CityId", "Lname", "UserId" },
                values: new object[] { 1, 1, "ahmadi", 3 });

            migrationBuilder.InsertData(
                table: "Experts",
                columns: new[] { "Id", "Lname", "UserId" },
                values: new object[] { 1, "ahamdi", 2 });
            ...
            migrationBuilder.InsertData(
                table: "Suggestions",
                columns: new[] { "Id", "CreateAt", "Description", "ExpertId", "IsAccepted", "IsActive", "OrderId", "Price", "TimeToDone" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 1, true, true, 1, 505000, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 1, false, true, 2, 505000, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
